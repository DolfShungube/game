...
export class Level3_World {
  ...
  async init() {
    ...
    this.combinationLock1 = combinationLockPuzzle.createBaseCombinationLock(
      this.dialTexture
    );
    this.combinationLock2 = combinationLockPuzzle.createBaseCombinationLock(
      this.dialTexture
    );
    this.combinationLock3 = combinationLockPuzzle.createBaseCombinationLock(
      this.dialTexture
    );
    this.combinationLock4 = combinationLockPuzzle.createBaseCombinationLock(
      this.dialTexture
    );
    this.combinationLock5 = combinationLockPuzzle.createBaseCombinationLock(
      this.dialTexture
    );
    this.combinationLock6 = combinationLockPuzzle.createBaseCombinationLock(
      this.dialTexture
    );
    this.combinationLock7 = combinationLockPuzzle.createBaseCombinationLock(
      this.dialTexture
    );
    this.combList = [
      ...
      this.combinationLock5,
      this.combinationLock6,
      this.combinationLock7,
    ];
    ...
    await new Promise((resolve) => {
      audioLoader.load(
        ...
        (error) => {
          ...
          updateLoadingStatus(
            "Music failed to load. Starting game without music."
          );
          resolve();
        }
      );
